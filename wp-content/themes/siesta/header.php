...
<div class="head-logo"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/logo.png" alt="SIESTA" width="53"></div>

<div class="navWrap">
<div class="navWrap_logo"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/logo.png" alt="SIESTA" width="53"></div>

	<nav class="gnav">
		<ul class="gnav_list">
			<li class="gnav_list_item"><a href="/">TOP</a></li>
			<li class="gnav_list_item"><a href="https://store.siesta81.com" target="_blank">WEB SHOP</a></li>
			<li class="gnav_list_item"><a href="https://blog.siesta81.com">BLOG</a></li>
			<li class="gnav_list_item"><a href="">CONTACT</a></li>
		</ul>
	</nav>
